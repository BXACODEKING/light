...
typedef struct
{
    GPIO_TypeDef* GPIOx;
    uint16_t GPIO_Pin;
} xensiv_bgt60trxx_st_iface_gpio;

typedef struct
{
    SPI_HandleTypeDef* spi;
    xensiv_bgt60trxx_st_iface_gpio selpin;
    xensiv_bgt60trxx_st_iface_gpio rstpin;
    xensiv_bgt60trxx_st_iface_gpio irqpin;
} xensiv_bgt60trxx_st_iface_t;
